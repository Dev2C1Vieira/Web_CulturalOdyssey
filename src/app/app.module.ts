...
@NgModule({
  declarations: [AppComponent, RegisterComponent, LoginComponent, DashboardComponent, LandingPageComponent, FooterComponent, CategoryPageComponent, MuseumCardComponent, SideNavbarComponent, HeadNavbarComponent, CreateMuseumComponent, GetMuseumsComponent, provideAnimationsAsync, ImageDialogComponent, CreateEventComponent, WineCategoryComponent, VinhoDoPortoComponent, ProductCardComponent, BlackettVintageComponent, ProductTemplateComponent, MuseumTemplateComponent],
  imports: [
    BrowserModule,
    FormsModule,
    AppRoutingModule,
